...
s.dynamicAccountList="redhatglobaltest=devlab.redhat.com,phx1.redhat.com,phx2.redhat.com,usersys.redhat.com,misc.hst.ams2.redhat.com,qa.redhat.com,qa.engage.redhat.com,stage.redhat.com,redhat.sc.stg.hodesdigital.com,webdrupal-aws-prod.redhat.com,www-admin.corp.redhat.com;redhatglobal,redhatcomglobal2014=www.redhat.com,ae.redhat.com,ar.redhat.com,at.redhat.com,au.redhat.com,bd.redhat.com,be.redhat.com,br.redhat.com,bt.redhat.com,ca.redhat.com,ch.redhat.com,cl.redhat.com,cn.redhat.com,co.redhat.com,cz.redhat.com,de.redhat.com,dk.redhat.com,ec.redhat.com,es.redhat.com,europe.redhat.com,fi.redhat.com,fr.redhat.com,gb.redhat.com,hk.redhat.com,id.redhat.com,ie.redhat.com,il.redhat.com,in.redhat.com,it.redhat.com,jp.redhat.com,kr.redhat.com,latam.redhat.com,lk.redhat.com,lt.redhat.com,lu.redhat.com,mx.redhat.com,my.redhat.com,nl.redhat.com,no.redhat.com,np.redhat.com,nz.redhat.com,pe.redhat.com,ph.redhat.com,pk.redhat.com,pt.redhat.com,py.redhat.com,ru.redhat.com,se.redhat.com,sg.redhat.com,th.redhat.com,tw.redhat.com,us.redhat.com,uy.redhat.com,ve.redhat.com,vn.redhat.com,za.redhat.com;redhatglobal,redhatcareers=jobs.redhat.com,redhat.sc.hodesdigital.com,careers-redhat.icims.com;redhatglobal,redhatjbossorg=jboss.org,hibernate.org,wildfly.org;redhatglobal=redhat.com;"
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,ogg,rm,ram,swf,flv,jar,mp4"
s.linkInternalFilters="javascript:,redhat.com,redhatmagazine.com,europe.redhat.com,cz.redhat.com,de.redhat.com,redhat.de,redhat.es,es.redhat.com,redhat.fr,fr.redhat.com,europe.redhat.com,redhat.it,it.redhat.com,redhat.com.cn,cn.redhat.com,kr.redhat.com,latam.redhat.com,redhat.com.br,br.redhat.com,latam.redhat.com,redhat.com.au,apac.redhat.com,redhat.in,in.redhat.com,jboss.org,jboss.com,mobicents.org,jp.redhat.com,hibernate.org,wildfly.org,careers-redhat.icims.com,jobs.redhat.com,redhat.sc.stg.hodesdigital.com,redhat.sc.hodesdigital.com"
s.linkLeaveQueryString=false
s.linkTrackVars="prop7,eVar7,prop21,eVar18,channel"
s.linkTrackEvents="None"
s.useForcedLinkTracking = false

/* Set variables to mark all pages that report through this file */
s.eVar12="next_redhat.com"
s.prop9="next_redhat.com"

/* Reporting for the current s_code version */
s.eVar20="drupal | H.25.4"
s.prop10="drupal | H.25.4"

/* Track user agent */
s.eVar44="D=User-Agent"
s.prop44="D=User-Agent"
...
s.Media.trackVars="events,prop38,eVar38,eVar39,eVar40";
s.Media.trackEvents="event35,event36,event37,event38,event39,event40,event41";
s.Media.contextDataMapping = {
	"a.media.name":"eVar38,prop38",
	"a.media.segment":"eVar39",
	"a.contentType":"eVar40",
	"a.media.timePlayed":"event41",
	"a.media.view":"event38",
	"a.media.segmentView":"event39",
...
function s_doPlugins(s) {
	...
	{
		s.eVar1=s.list1=s.getQueryParamNC('intcmp');
		if (s.events) {
			s.events += ", event31";
		} else {
			s.events = "event31";
	...
	// set offer cookie when offer_id is present in QS
	...
	// Conversion Referral Querystring Tracking
	if((document.URL.indexOf("/training/") !== -1) || (document.URL.indexOf("/resourcelibrary/") !== -1)) {
		if(!s.eVar34 && s.getQueryParamNC('cr'))
		{
			s.eVar34=s.prop34=s.getQueryParamNC('cr');
		}
	}
	
	//previous page name
	s.prop57 = s.getPreviousValue(s.pageName,'s_prev_pn','');  
	  
	//percent page viewed of previous page
 ...
 * Source: Adobe
 * https://microsite.omniture.com/t2/help/en_US/sc/implement/index.html#getQueryParam
 */
 ...
 * Source: Adobe (variant of getQueryParam above)
 * https://microsite.omniture.com/t2/help/en_US/sc/implement/index.html#getQueryParam
 */
 ...
 * Source: Adobe
 * https://microsite.omniture.com/t2/help/en_US/sc/implement/index.html#getValOnce
 */
 ...
 * Source: Adobe
 * https://microsite.omniture.com/t2/help/en_US/sc/implement/index.html#getTimeParting
 * 
 ...
 * Source: Adobe
 * https://microsite.omniture.com/t2/help/en_US/sc/implement/index.html#detectRIA
 */
 ...
 * Source: Adobe
 * https://microsite.omniture.com/t2/help/en_US/sc/implement/index.html#getNewRepeat
 */
 ...
 * Source: Adobe
 * https://microsite.omniture.com/t2/help/en_US/sc/implement/index.html#getVisitNum
 */
 ...
 * Source: Adobe
 * https://microsite.omniture.com/t2/help/en_US/sc/implement/index.html#getPreviousValue
 */
...
if(!getCookie('rh_pid')){
    var var_pid = s.getQueryParamNC('pid');
    if(var_pid){
        s.setCookieParam('rh_pid',var_pid,1,1);
    }
}
...
;/**/
/* Source and licensing information for the line(s) below can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_analytics.js. */
s.rh_url=decodeURI(window.location.hostname+window.location.pathname).toLowerCase();s.rh_urlSplit=s.rh_url.toLowerCase().split(/\//);s.pageName=Drupal.settings.rh_analytics_title||'';if(Drupal.settings.rh_analytics_title_add_location)s.pageName+=' | '+window.location.href;s.prop7=s.eVar7="D=pageName";s.server="redhat.com | drupal";if(Drupal.settings.rh_analytics_page_type)s.pageType=Drupal.settings.rh_analytics_page_type;if(Drupal.settings.rh_analytics_error_status){if(document.referrer){var referrerParser=document.createElement('a');referrerParser.href=document.referrer;if(referrerParser.hostname==window.location.hostname){var referrerPath=referrerParser.pathname.split('/');referrerPath.shift();referrerPath.shift();s.prop58=referrerPath.shift()}else s.prop58='external site'}else s.prop58="no referrer";var windowPath=window.location.pathname.split('/');windowPath.shift();windowPath.shift();s.prop59=windowPath.shift();s.prop60=s.pageName;rh_analytics_add_events(s,"event60");s.eVar60=Drupal.settings.rh_analytics_error_status}else{s.channel=s.rh_urlSplit[2]||"home page";s.prop2=s.eVar22=Drupal.settings.rh_analytics_langcode||'';s.prop5=s.eVar25=Drupal.settings.rh_analytics_subtype||'';s.prop4=s.eVar23=window.location.search;s.prop21=s.eVar18=s.rh_url;s.prop13=s.eVar26=Drupal.settings.rh_analytics_node_id||'';if(s.channel=='search'){s.prop14=s.eVar27=''}else s.prop14=s.eVar27=s.rh_urlSplit[3]||"";s.prop15=s.eVar28=s.rh_urlSplit[4]||"";s.prop16=s.eVar29=s.rh_urlSplit[5]||"";if(rh_analytics_get_cookie('rh_analytics_clickpath')!==undefined)s.prop32=rh_analytics_get_cookie('rh_analytics_clickpath')};var training_events=Drupal.settings.rh_analytics_training_events||'';rh_analytics_add_events(s,training_events);s.products=Drupal.settings.rh_analytics_training_products||'';s.prop17=s.eVar4=Drupal.settings.rh_analytics_search_keywords||'';s.prop22=Drupal.settings.rh_analytics_search_num_results||'';var search_events=Drupal.settings.rh_analytics_search_events||'';rh_analytics_add_events(s,search_events)
function rh_analytics_add_events(s,events){if(events)s.events=(s.hasOwnProperty('events'))?s.events+', '+events:events}
function rh_analytics_get_cookie(name){var value="; "+document.cookie,parts=value.split("; "+name+"=");if(parts.length==2)return parts.pop().split(";").shift()};
/* Source and licensing information for the above line(s) can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_analytics.js. */
/* Source and licensing information for the line(s) below can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_analytics_internalcompaign.js. */
(function($){Drupal.behaviors.rh_analytics_internalcompaign={attach:function(context,settings){if(s){var promo_viewed=[],rh_offer_id_collected=[],rh_offer_ids='';$('a.cta-primary[href*="intcmp="]',context).each(function(){var href=$(this).attr('href'),visible=$(this).is(':visible');if(href&&visible&&promo_viewed.indexOf(href)<0){var rh_offer_id=redhat_www_analytics_find_intcmp(href);if(rh_offer_id&&rh_offer_id_collected.indexOf(rh_offer_id)==-1)rh_offer_id_collected.push(rh_offer_id);promo_viewed[promo_viewed.length]=href}});if(rh_offer_id_collected.length>0){rh_offer_ids=rh_offer_id_collected.join(",");redhat_www_analytics_track_impresssion(rh_offer_ids);rh_offer_id_collected=[]};$('.carousel',context).on("slid.bs.carousel",function(){$('div.active',context).each(function(){var href=$(this).find('a.cta-primary').attr('href'),visible=($(this).css('display')!='none')?true:false;if(href&&visible&&promo_viewed.indexOf(href)<0){rh_offer_ids=redhat_www_analytics_find_intcmp(href);redhat_www_analytics_track_impresssion(rh_offer_ids);promo_viewed[promo_viewed.length]=href}})})}}}
function redhat_www_analytics_find_intcmp(link){var rh_offer_id='';if(/intcmp=[0-9]+/.test(link))rh_offer_id=link.substring(link.indexOf("intcmp=")+7,link.length);return rh_offer_id.trim()}
function redhat_www_analytics_track_impresssion(rh_offer_id){if(rh_offer_id){s.list1=rh_offer_id;s.events="event32";s.linkTrackVarsTemp=s.linkTrackVars;s.linkTrackEventsTemp=s.linkTrackEvents;s.linkTrackVars+=",eVar1,list1,events";s.linkTrackEvents="event32";s.tl(this,'o','promo impression');s.linkTrackVars=s.linkTrackVarsTemp;s.linkTrackEvents=s.linkTrackEventsTemp}}})(jQuery);;
/* Source and licensing information for the above line(s) can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_analytics_internalcompaign.js. */
/* Source and licensing information for the line(s) below can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_video.js. */
(function($){jQuery(document).bind('hidden.bs.modal',function(){var identifier='';$('.modal.video iframe[src*="youtube"]').each(function(){identifier=$(this).attr('id');Drupal.behaviors.rh_analytics_video.players[identifier].opened=false;Drupal.behaviors.rh_analytics_video.youTubeApiAddEvents(identifier,this)})});Drupal.behaviors.rh_analytics_video={players:{},addJs:false,isSetup:false,attach:function(context,settings){Drupal.behaviors.rh_analytics_video.setUpYouTubeTracking(context);if(Drupal.behaviors.rh_analytics_video.addJs&&!Drupal.behaviors.rh_analytics_video.isSetup)Drupal.behaviors.rh_analytics_video.setUpYouTubeApi()},setUpYouTubeTracking:function(context){$('iframe',context).each(function(){var $this=$(this);if(/youtube/i.test($this.attr('src'))){Drupal.behaviors.rh_analytics_video.addJs=true;var identifier=$this.attr('id');if(!identifier){var i=0,temp_id='youtube_video_';while($('#'+temp_id+i).length)i++;identifier=temp_id+i;$this.attr('id',identifier)};var url_video_src=$this.attr('src'),url_match,url_regexpl=/\+/g,url_search=/([^&=]+)=?([^&]*)/g,url_decode_param=function(s){return decodeURIComponent(s.replace(url_regexpl," "))},url_video_src_params={};url_video_src=url_video_src.split(/[?](.+)?/);var url_video_src_url=url_video_src[0];if(typeof url_video_src[1]!=='undefined'&&0<url_video_src[1].length)while(url_match=url_search.exec(url_video_src[1]))url_video_src_params[url_decode_param(url_match[1])]=url_decode_param(url_match[2]);if(!url_video_src_params.hasOwnProperty('enablejsapi'))url_video_src_params.enablejsapi='1';if(!url_video_src_params.hasOwnProperty('playerapiid'))url_video_src_params.playerapiid=identifier;url_video_src=url_video_src_url+'?';for(var query_arg in url_video_src_params)url_video_src+=query_arg+'='+url_video_src_params[query_arg]+'&';url_video_src=url_video_src.replace(/\&$/,'');$this.attr('src',url_video_src);$this.addClass('rh-analytics-youtube');$this.on('rhanaylticsyoutubeready',function(){Drupal.behaviors.rh_analytics_video.youTubeApiAddEvents(identifier,this)})}})},youTubeApiAddEvents:function(identifier,iframe){var newYouTubePlayer=new YT.Player(identifier,{events:{onStateChange:function(event){var player=Drupal.behaviors.rh_analytics_video.players[identifier].player,duration=player.getDuration(),currentTime=player.getCurrentTime();if(!player.hasOwnProperty('rh_title'))player.rh_title=player.getVideoData().title;if(event.data==YT.PlayerState.PLAYING){if(!Drupal.behaviors.rh_analytics_video.players[identifier].opened){s.eVar45="video";s.events="event45";s.linkTrackVarsTemp=s.linkTrackVars;s.linkTrackEventsTemp=s.linkTrackEvents;s.linkTrackVars+=",eVar45,list1,events";s.linkTrackEvents="event45";s.list1=s.c_r('rh_omni_itc');s.tl(iframe,'o','Consumption conversion event');s.linkTrackVars=s.linkTrackVarsTemp;s.linkTrackEvents=s.linkTrackEventsTemp;s.Media.open(player.rh_title,duration,"youtube");Drupal.behaviors.rh_analytics_video.players[identifier].opened=true};s.Media.play(player.rh_title,currentTime)}else if(event.data==YT.PlayerState.PAUSED){s.Media.stop(player.rh_title,currentTime)}else if(event.data==YT.PlayerState.ENDED){s.Media.stop(player.rh_title,currentTime);s.Media.close(player.rh_title)}}}});if(!Drupal.behaviors.rh_analytics_video.players.hasOwnProperty(identifier))Drupal.behaviors.rh_analytics_video.players[identifier]={player:newYouTubePlayer,opened:false}},setUpYouTubeApi:function(){Drupal.behaviors.rh_analytics_video.isSetup=true;(function(){var s=document.createElement("script");s.src="https://www.youtube.com/player_api";var before=document.getElementsByTagName("script")[0];before.parentNode.insertBefore(s,before)})()}}})(jQuery)
function onYouTubeIframeAPIReady(){(function($){$('.rh-analytics-youtube').trigger('rhanaylticsyoutubeready')})(jQuery)};
/* Source and licensing information for the above line(s) can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_video.js. */
/* Source and licensing information for the line(s) below can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_demand_base.js. */
db_cta=function(){};var dbPage=document.location.href;if(top!=self)dbPage=document.referrer;dbPage=encodeURIComponent(dbPage);dbApi=document.createElement('script');dbApi.src='//api.demandbase.com/api/v2/ip.json?key=223190404d28f4fcabacfadefef244ea33868fb1&callback=db_cta&page='+dbPage+'&page_title='+document.title+'&referrer='+document.referrer;dbView=document.createElement('img');dbView.src='//a.company-target.com/pixel?id=1395249215&type=img&nr=1';dbView.style.display='none';dbRetarget=document.createElement('img');dbRetarget.src='//a.company-target.com/pixel?id=1395249326&type=img&nr=1';dbRetarget.style.display='none';dbSc=document.getElementsByTagName('head')[0];dbSc.appendChild(dbApi);dbSc.appendChild(dbView);dbSc.appendChild(dbRetarget);;
/* Source and licensing information for the above line(s) can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_demand_base.js. */
/* Source and licensing information for the line(s) below can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_analytics_nav_tracking.js. */
(function($){Drupal.behaviors.rh_analytics_nav={attach:function(context,settings){$(context).on("click","a",function(e){var clickpath=[];if($(this).parents('header').length){var path_name;if($(this).parent('li').attr('id')=='utility-search'||$(this).closest('.utility-panel').attr('id')=='search-panel'){path_name="utility tray | search"}else if($(this).parent('li').attr('id')=='utility-account'||$(this).closest('.utility-panel').attr('id')=='account-panel'){path_name="utility tray | user"}else if($(this).parent('li').attr('id')=='utility-globe'||$(this).closest('.utility-panel').attr('id')=='globe-panel'){path_name="utility tray | globe"}else path_name="header";if($(this).hasClass('open')&&!$(this).parents('div').hasClass('utility-content'))s.tl(this,'o','rh | '+path_name);clickpath.push(path_name)}else if($(this).parents('footer').length){clickpath.push('footer')}else{var parents=$(this).parents('section.band');for(i=0;i<parents.length;++i){var $parent=$(parents[i]);if($parent.attr('id')){clickpath.push($parent.prop('tagName')+'#'+$parent.attr('id'))}else if($parent.attr('class')){clickpath.push($parent.prop('tagName')+'.'+$parent.attr('class'))}else clickpath.push($parents.prop('tagName'))}};if(clickpath.length>0){var d=new Date();d.setTime(d.getTime()+(15*1e3));var path=clickpath.reverse().join(' | ');document.cookie="rh_analytics_clickpath="+path+'; expires='+d.toGMTString()+'; path=/'}})}}})(jQuery);;
/* Source and licensing information for the above line(s) can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_analytics_nav_tracking.js. */
/* Source and licensing information for the line(s) below can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_omni_footer.js. */
...
/* Source and licensing information for the above line(s) can be found at http://www.redhat.com/pt-br/profiles/rh/modules/redhat_www_analytics/js/rh_omni_footer.js. */
